// store code with set of questions
// route can then call random question
const questions = [
    {
...
function randomWYRQuestion() {
    const randomIndex = Math.floor(Math.random() * questions.length) // pick random number between 0 and 1 * by number of questions gets us number and rounds down
    const randomQuestion = questions[randomIndex]
    return randomQuestion
}
// make this function accesible to index.js
